...
(function(root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.startDate = this.element.data('start-value')?moment(this.element.data('start-value')):moment().startOf('day');
            this.endDate = this.element.data('end-value')?moment(this.element.data('end-value')):moment().endOf('day');
